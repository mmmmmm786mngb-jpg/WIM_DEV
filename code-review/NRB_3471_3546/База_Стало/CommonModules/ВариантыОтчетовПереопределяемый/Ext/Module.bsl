...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.СправочнаяИнформация);
	Разделы.Добавить(Метаданные.Подсистемы.ИнформационныеОперации);
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// _Демо начало примера
	//Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты._ДемоДинамикаИзмененийФайлов, "Основной");
	//Вариант.Описание = НСтр("ru = 'Динамика изменений файлов в виде графика.'");
	//Вариант.Размещение.Удалить(Метаданные.Подсистемы._ДемоОрганайзер);
	//Вариант.Размещение.Вставить(Метаданные.Подсистемы._ДемоОрганайзер.Подсистемы._ДемоРаботаСФайлами.Подсистемы.Настройка, "Важный");
	//Вариант.ФункциональныеОпции.Добавить("ХранитьФайлыВТомахНаДиске");
	//
	//Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты._ДемоДокументыАрхива, "Основной");
	//Вариант.Описание = НСтр("ru = 'Список файлов и их авторов в табличном виде.'");
