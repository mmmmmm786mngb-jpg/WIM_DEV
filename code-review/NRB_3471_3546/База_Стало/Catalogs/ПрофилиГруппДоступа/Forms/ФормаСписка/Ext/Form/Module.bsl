...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		МассивПрофилей.Добавить(Справочники.ПрофилиГруппДоступа.Администратор);
		МассивПрофилей.Добавить(Справочники.ПрофилиГруппДоступа.РедактированиеПользователей);
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			Список, "Ссылка", МассивПрофилей,
