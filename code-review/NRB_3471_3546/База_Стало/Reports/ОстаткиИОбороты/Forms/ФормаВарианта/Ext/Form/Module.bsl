...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)	
	...
	Параметры.Свойство("АдресПромежуточныхНастроек", АдресПромежуточныхНастроек);
	Параметры.Свойство("Раздел", Отчет.Раздел);	
...
&НаСервере
Процедура ПоместитьНастройкиНаСервере()
	
	НастройкиКомпоновщика = Отчет.КомпоновщикНастроек.ПолучитьНастройки();
	ПоместитьВоВременноеХранилище(НастройкиКомпоновщика, АдресПромежуточныхНастроек);
