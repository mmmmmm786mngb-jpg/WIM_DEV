...
Функция ЗаписатьВПротоколВыполнения(Код="", СтруктураЗаписи=Неопределено, ВзвестиФлагОшибок=Истина, 
	...
	Если ВзвестиФлагОшибок Тогда
	   ...
	   ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ИтоговаяСтрокаДляЗаписи);
...
Функция ЗаписатьИнформациюОбОшибкеВПротокол(КодСообщения, СтрокаОшибки, Объект, ТипОбъекта = Неопределено)
...
Процедура УстановитьТекущуюДатуРеквизиту(РеквизитОбъекта)
	...
	#Если Клиент Тогда
		РеквизитОбъекта = ОбщегоНазначенияКлиентСервер.РабочаяДата();
	#Иначе
...
Функция ОбработатьПоискОбъектаПоСтруктуре(НомерОбъекта, ТипОбъекта, СозданныйОбъект, 
	...
	Если СтруктураДанных <> Неопределено Тогда
		...
		Если СтруктураДанных. Ссылка = Неопределено Тогда
