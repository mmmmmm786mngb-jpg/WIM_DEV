...
#Если НаКлиенте Тогда
	Если ОбщегоНазначенияКлиент.КлиентПодключенЧерезВебСервер()
		...
		Возврат УправлениеСоединениямиИБ.ОтключитьСеанс(НомерСеанса, СообщениеОбОшибке);
	КонецЕсли;
#КонецЕсли
...
Процедура ЗаписатьНазванияСоединенийИБ(ТекстСообщения) Экспорт
	...
	ЗаписьЖурналаРегистрации(НСтр("ru = 'Завершение работы пользователей'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
...
#Если НаКлиенте Тогда
	ОбщегоНазначенияКлиент.ДобавитьСообщениеДляЖурналаРегистрации(НСтр("ru = 'Завершение работы пользователей'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
