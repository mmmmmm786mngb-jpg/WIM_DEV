...
&НаКлиенте
Процедура НачальноеЗаполнениеВерсий(Команда)
	ОткрытьФорму("РегистрСведений.НастройкиВерсионированияОбъектов.Форма.НачальноеЗаполнениеВерсийОбъектов",,ЭтаФорма,УникальныйИдентификатор);
КонецПроцедуры
