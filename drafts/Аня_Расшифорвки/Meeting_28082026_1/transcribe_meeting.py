#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rasshifrovka audio sobraniya 28.08.2026 (faster-whisper)."""
...
AUDIO = Path(r"c:\1c\Cursor_1c\WIM_DEV\drafts\Аня_Расшифорвки\Meeting_28082026_1\28.08.2026 10.00.m4a")
OUT_DIR = Path(r"c:\1c\Cursor_1c\WIM_DEV\drafts\Аня_Расшифорвки\Meeting_28082026_1")
