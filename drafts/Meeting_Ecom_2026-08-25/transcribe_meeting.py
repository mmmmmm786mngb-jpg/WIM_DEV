#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rasshifrovka audio sobraniya (faster-whisper)."""
...
AUDIO = Path(r"c:\Users\Acer\Downloads\25.08.2026 13.00 (1).m4a")
OUT_DIR = Path(r"c:\1c\Cursor_1c\WIM_DEV\drafts\Meeting_Ecom_2026-08-25")
