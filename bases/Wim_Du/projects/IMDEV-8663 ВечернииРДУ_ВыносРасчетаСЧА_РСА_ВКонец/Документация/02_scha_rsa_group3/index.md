...
Группу 3 и перенос пяти операций на информационной базе делает **внешняя обработка для поддержки**, не код расширения. Обработка `ПереносОперацийСЧА_РСАВГруппу3.epf` создана и проверена (07.09.2026), есть возврат в вечерние.

## Документы

| Файл | Назначение |
|---|---|
| [prompt_imdev8663_2_extension_cf_152910.html](prompt_imdev8663_2_extension_cf_152910.html) | **Актуальный промпт (ревизия 07.09.2026)**: CF 1.5.29.10, расширение IM86632 и обработка поддержки для группы 3. Обработка создана и проверена |
| [support_move_scha_rsa_group3.html](support_move_scha_rsa_group3.html) | Инструкция для отдела поддержки: как пользоваться обработкой переноса СЧА/РСА |
