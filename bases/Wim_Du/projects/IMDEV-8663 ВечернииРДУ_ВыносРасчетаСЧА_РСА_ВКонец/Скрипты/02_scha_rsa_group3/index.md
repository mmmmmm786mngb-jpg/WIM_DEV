...
| `run_com_test_cancel_g2_then_g3.py` | COM-сценарий: отмена группы 2 после 50 из 600, затем группа 3 «по всем». HTML `imdev86632_test_report_cancel_g2_then_g3_all.html` |
