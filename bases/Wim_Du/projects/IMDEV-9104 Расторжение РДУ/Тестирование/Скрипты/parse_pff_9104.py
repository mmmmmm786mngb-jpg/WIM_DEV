#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Parse IMDEV-9104 Замер_50_Договоров.pff into hotspot summary."""
...
PFF = Path(
    ...
    r"Расторжение РДУ\Тестирование\Замер_50_Договоров.pff"
)
OUT = Path(
    r"c:\1c\Cursor_1c\WIM_DEV\bases\Wim_Du\projects\IMDEV-9104 "
    r"Расторжение РДУ\Тестирование\reports\pff_hotspots_50.json"
)
...
def main() -> None:
    ...
    keys = (
        "поручен", "расторж", "сча", "рса", "договор", "записать", "проведен",
        "статус", "вывод", "расчетсч", "данныепо", "внтест", "закрыт", "банк",
        "аналит", "получитьсумм", "установитьдат",
    )
    print("\n===FOCUS_t1>=0.05===")
    focus = []
