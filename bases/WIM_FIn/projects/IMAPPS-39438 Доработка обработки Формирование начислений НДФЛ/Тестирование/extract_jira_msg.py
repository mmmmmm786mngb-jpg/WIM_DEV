...
def main():
    p = pathlib.Path(
        r"bases/WIM_FIn/projects/IMAPPS-39438 Доработка обработки Формирование начислений НДФЛ/"
        r"JIRA Updates for IMAPPS-39438 Доработка обработки Формирование начислений НДФЛ.msg"
    )
    data = p.read_bytes()
