...
# -*- coding: utf-8 -*-
"""
Sverka NDFL: etalon 27292 vs PoNovomu Avancor 6 (3 rasshirenija vlitie v CF).
...
OUT_HTML = os.path.join(DOC, "imdev7330_ndfl_old_vs_avancor6_diff.html")
OUT_JSON = os.path.join(DOC, "imdev7330_ndfl_old_vs_avancor6_diff.json")

FILES = {
    "uk_old": os.path.join(BASE, "НДФЛ_Управление_27292.xlsx"),
    "uk_n4": os.path.join(BASE, "НДФЛ_Управление_27292_ПоНовому_Аванкор_6.xlsx"),
    "pf_old": os.path.join(BASE, "НДФЛ_Портфели_27292.xlsx"),
    "pf_n4": os.path.join(BASE, "НДФЛ_Портфели_27292_ПоНовому_Аванкор_6.xlsx"),
    "msg_old": os.path.join(BASE, "Сообщения_поСтарому_Аванкор.txt"),
    "msg_n4": os.path.join(BASE, "Сообщения_поНовому_Аванкор_6.txt"),
    "log_n4": os.path.join(BASE, "Лог формирования начисдений НДФЛ_ПоНовому_Аванкор_6.xlsx"),
}
