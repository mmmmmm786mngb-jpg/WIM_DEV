...
- [imdev8641_final_development_tz.html](imdev8641_final_development_tz.html) — окончательное ТЗ (статус RduPF, алгоритм, модуль менеджера РС; раздел 8.1 — таблица пяти видов для первичного заполнения РС и веток кода).
...
- [filter_plan_regl_operations_table_integration.md](filter_plan_regl_operations_table_integration.md) — встраивание фильтра таблицы плана, колонки и типы `ПланРеглОпераций`; прод — EPF Аванкор.
- [pul_roznica_du_constant.md](pul_roznica_du_constant.md) — константа `ПулРозницаДУ` (типовая CF, заполнение в ИБ, проверка скриптом).
- `../ДоработкиОтАванкор/prompt_implement_epf_algoritm_dop_deystviy.md` — промпт переноса логики в EPF.
- `../ДоработкиОтАванкор/how_it_looks_in_code_from_docx.md` — точка входа 2.8.5.x, `ПланРегламентныхОпераци`.
