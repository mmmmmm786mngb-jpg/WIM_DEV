# Документация IMAPPS-36274 (HTML)

| Файл | Назначение |
| ---- | ---------- |
| [imapps36274_01_current_architecture.html](imapps36274_01_current_architecture.html) | Как сейчас связаны справочник настроек, обработка и регламентное задание |
...
Путь к исходникам базы: `bases/WIM_FIn/source-path.txt` (обычно `C:\1c\Cursor_1c\WORK\WIM_FIn`).
